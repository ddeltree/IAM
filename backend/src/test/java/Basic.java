...
public class Basic {
  ...
  public void testSoma() {
    ...
    // var documento2 = ResourceFactory.createResource(ResourceTypes.TURMA); //
    ...
    // var usuarioAdmin = new User("admin1"); // admin1 é só um id desnecessário,
    // para prints
    ...
    // grupoAdmin.grantPermission(poderVerDocumento); // o usuário admin herda a
    // permissão do grupo
    // grupoAdmin.grantPermission(poderExcluirDocumento); // apenas admins podem
    // excluir documentos
    // MembershipManager.link(usuarioAdmin, grupoAdmin); // adicionar o admin ao
    // grupo dos admins

    // // CHECANDO PERMISSÕES
    // var podeComumVerDocumento = PermissionService.hasPermission(usuarioComum,
    // poderVerDocumento);
    // var podeComumExcluirDocumento = PermissionService.hasPermission(usuarioComum,
    // Action.DELETE, documento2);
    // var podeAdminVerDocumento = PermissionService.hasPermission(usuarioAdmin,
    // Action.VIEW, documento);
    // var podeAdminExcluirDocumento = PermissionService.hasPermission(usuarioAdmin,
    // poderExcluirDocumento);
